 ...
 * path, e.g.</p>
 * <code>java -Dxr-conf=conf/myprops.conf</code>
 * <p>
...
public class Configuration {
     ...
     */
    private final static String SF_FILE_NAME = "conf/xhtmlrenderer.conf";
    ...
    private Properties newFallbackProperties() {
        ...
        props.setProperty("xr.css.user-agent-default-css", "/css/");
